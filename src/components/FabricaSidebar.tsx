...
export function FabricaSidebar({ className = '', onNavigate, currentPage = 'fabrica-dashboard' }: FabricaSidebarProps) {
  ...
  const menuItems: MenuItem[] = [
    {
      id: 'fabrica-dashboard',
      title: 'Dashboard',
      icon: <HomeIcon size={20} />,
      onClick: () => {
        setActiveItem('fabrica-dashboard')
        onNavigate?.('fabrica-dashboard')
      }
    },
    {
      id: 'fabrica-inventory',
      title: 'Inventario',
      icon: <TableIcon size={20} />,
      onClick: () => {
        setActiveItem('fabrica-inventory')
        onNavigate?.('fabrica-inventory')
      }
    },
    {
      id: 'fabrica-quotes',
      ...
      onClick: () => {
        setActiveItem('fabrica-quotes')
        onNavigate?.('fabrica-quotes')
      }
    },
    {
      id: 'fabrica',
